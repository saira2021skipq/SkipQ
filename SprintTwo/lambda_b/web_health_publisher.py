...
def health_web(event,context):
    ...
    for url in url_array:
        ...
        response_latency=temp_obj.create_metrics(constants.URL_MONITER_MATRIC_NAME_LATENCY,constants.URL_MONITER_NAMESPACE,dim,latency,"Milliseconds")
        #call for metric creation for availability
        response_availability=temp_obj.create_metrics(constants.URL_MONITER_MATRIC_NAME_AVAIALABILITY,constants.URL_MONITER_NAMESPACE,dim,availability,"None")
